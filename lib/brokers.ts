...
export const brokers: Broker[] = [
  ...
  },
  {
    ...
    summary:
      "High-visibility quick-trading brand. Product page is available, while regulatory and partner-term details need a stronger source trail.",
    founded: "2017",
    ...
    restrictedRegions: ["United States checks required", "EEA checks required", "Malaysia warning-list checks"],
    riskLevel: "very_high",
    reviewStatus: "tracked",
    sourceConfidence: "official_basics",
    lastVerifiedAt: "2026-05-12",
    ...
    keyNotes: [
      ...
      "Regulation and complaint records require strong warning treatment",
    ],
    affiliateProgram: {
      slug: "pocket-option",
  ...
  },
  {
    ...
    keyNotes: ["Official article references 2013 launch", "Official article references CySEC 247/14 for EEA entity"],
    affiliateProgram: {
      slug: "iq-option",
      name: "IQ Option affiliate program",
      commercialStatus: "listed",
      model: "RevShare + CPA offer family",
      evidenceStatus: "Official affiliate pages found; offer availability varies by brand/entity and region.",
      cpaRange: "Instant CPA mentioned by affiliate pages; exact rate needs login/offer verification",
      revshareRange: "Up to 50% revenue share for active traders",
      cookieDuration: "Needs verification",
      payoutFrequency: "Twice per month per official affiliate page",
      paymentMethods: ["Preferred online payment system", "Specific rails require affiliate account verification"],
      restrictedGeos: ["United States", "Region-specific restrictions"],
      ...
      trackingNotes: [
        ...
        "Public pages mention migration/availability through Affstore, so current offer access should be rechecked.",
      ],
      dueDiligenceNotes: [
  ...
  },
  {
    ...
    summary:
      "Options and derivatives platform with comparatively stronger official documentation for product types, deposits, and withdrawals.",
    founded: "1999",
    ...
    keyNotes: ["Official options product page available", "Deposits and withdrawals documented in help centre"],
    affiliateProgram: {
      slug: "deriv",
      ...
      cpaRange: "Needs verification",
      evidenceStatus: "Official partner page found with public options and CFD commission language.",
      revshareRange: "Up to 45% commission headline; options turnover up to 1.5% and up to 40% of commissions on some contract types",
      cookieDuration: "Needs verification",
      payoutFrequency: "Daily and monthly payout language appears on official partner page",
      paymentMethods: ["Partner Hub payout methods need account verification"],
      restrictedGeos: ["United States", "Canada", "Hong Kong"],
  ...
  },
  {
    ...
    legalName: "Binarium",
    summary:
      "Binary-options brand added to the watchlist. Commercial, deposit, and regulatory claims should remain in verification queue.",
    ...
    platformType: "Binary options",
    restrictedRegions: ["Needs verification"],
    riskLevel: "very_high",
    reviewStatus: "needs_verification",
    sourceConfidence: "needs_verification",
    lastVerifiedAt: "2026-05-12",
    officialUrl: "https://binarium.com/",
    keyNotes: ["Requested for inclusion", "Do not index commercial claims until source trail is improved"],
    affiliateProgram: {
      slug: "binarium",
...
function createPocketOptionReview(): BrokerReview {
  return {
    overallScore: 1.9,
    trustScore: 18,
    externalScore: "WikiFX currently lists PocketOption with a very low score and no valid forex license in its broker profile",
    scoreLabel: "Very high-risk / source-limited",
    ratingSummary:
      "Pocket Option has official material for low minimum deposit, demo access, and payment-policy basics, but the review score is held down by weak regulatory confidence, warning-list reporting, and third-party complaint records around withdrawals and account access.",
    verdict:
      "Pocket Option should be treated as a very high-risk quick-trading venue. The strongest verified facts are official account-basics pages; regulation, complaint history, and withdrawal reliability remain the main unresolved risk areas.",
    ...
    withdrawalTime: "Official payment policy states withdrawals are processed within five business days after request acceptance",
    platform: "Proprietary/self-developed web platform reported by third-party broker databases",
    regulation:
      "No verified tier-one license; WikiFX reports no valid forex license, and BrokersView reports regulator warnings/cancelled licensing concerns",
    companyEntity: "FX Trading LLC / Pocket Option references appear across third-party broker databases",
    tradeableSymbols:
    ...
    paymentMethods: [
      "Official payment policy says methods must be those shown in the account dashboard",
      "Withdrawals generally return through the original payment route where applicable",
      "Minimum/maximum withdrawal amounts vary by method",
    ],
    pros: [
    ...
    cons: [
      "No verified tier-one financial regulation in the gathered sources",
      "WikiFX profile and articles report low broker scores and unresolved complaints",
      "BrokersView reports warnings from multiple regulators and cancelled licensing concerns",
    ...
    safetyChecks: [
      ...
      },
      {
        label: "Tier-one regulation",
        status: "fail",
        detail: "No FCA, CySEC, ASIC, CFTC or equivalent top-tier supervision is verified in the gathered sources.",
      },
      {
        label: "Payment terms",
        status: "warning",
    ...
    faqs: [
      {
        ...
        answer:
          "We did not verify a tier-one financial license for Pocket Option. Third-party broker databases report no valid forex license and elevated regulatory risk.",
      },
      {
...
function createIqOptionReview(): BrokerReview {
  return {
    overallScore: 3.2,
    trustScore: 64,
    externalScore: "WikiFX identifies a CySEC-regulated EEA entity but also flags complaint volume and global-entity risk",
    scoreLabel: "Mixed / entity-dependent",
    ratingSummary:
      "IQ Option has a stronger source trail than most binary-options brands because official materials identify a 2013 launch and CySEC 247/14 for IQ Option Europe Ltd. The score stays mixed because protections depend on the entity and region, and third-party databases still flag complaints.",
    verdict:
    ...
    regulation: "CySEC 247/14 for IQ Option Europe Ltd in the EEA; non-EEA entity protection differs",
    companyEntity: "IQ Option Europe Ltd / IQ Option group entities; non-EEA routing must be checked",
    ...
    pros: [
      ...
      "CySEC 247/14 is documented for the EEA entity",
    ...
    safetyChecks: [
      {
        label: "EEA license",
        status: "pass",
        detail: "Official and third-party sources reference IQ Option Europe Ltd regulated by CySEC under license 247/14.",
      },
      {
    ...
    timeline: [
      ...
      { year: "2014", title: "CySEC license reference", detail: "CySEC 247/14 is associated with IQ Option Europe Ltd for EEA operations." },
    ...
    faqs: [
      {
        ...
        answer:
          "IQ Option Europe Ltd is associated with CySEC license 247/14 for EEA users. Users outside the EEA should verify the exact contracting entity because protections can differ.",
      },
      {
...
function createDerivReview(): BrokerReview {
  return {
    overallScore: 3.7,
    trustScore: 72,
    externalScore: "Official source trail is comparatively strong; entity and country restrictions still matter",
    scoreLabel: "Better documented / still high-risk products",
    ratingSummary:
      "Deriv has the strongest documentation trail in this binary-options group: official pages explain digital options, payment methods, processing timelines, minimum deposits/withdrawals, and partner economics. The score is limited by derivative-product risk and entity/country restrictions.",
    verdict:
    ...
    withdrawalTime: "Internal deposits/withdrawals processed within 24 hours depending on method and checks; bank/PSP timing can add delay",
    platform: "Deriv Trader, Deriv Bot, Deriv GO, SmartTrader, MT5/cTrader availability by product",
    regulation: "Multi-entity group; users must verify the specific entity and jurisdiction before opening an account",
    ...
    paymentMethods: ["Cards", "E-wallets", "Crypto wallets", "Deriv P2P", "Online banking", "Fiat onramp"],
    pros: [
      ...
      "Official partner page gives public commission and payout model language",
    ],
    cons: [
    ...
    safetyChecks: [
      { label: "Official docs", status: "pass", detail: "Product, help-center and partner-program pages were found and source-dated." },
      { label: "Payment clarity", status: "pass", detail: "Deriv explains payment methods, processing timing and minimum deposit/withdrawal ranges." },
    ...
    timeline: [
      ...
      { year: "2026", title: "Review refresh", detail: "Official help-center, product and partner pages were added to the current profile." },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Deriv's help center says minimum deposit and withdrawal depend on method, with the lowest e-wallet range at 5 to 10 USD/EUR/GBP/AUD.",
      },
      {
...
function createBinariumReview(): BrokerReview {
  return {
    overallScore: 1.3,
    trustScore: 10,
    externalScore: "WikiFX/BrokersView report unregulated status, CySEC/FCA warning records and low credibility scores",
    scoreLabel: "Very high-risk / research-only",
    ratingSummary:
      "Binarium is included because users asked for coverage, not because the source trail is strong. Official commercial claims are weak, while broker databases report unregulated status, warning records and withdrawal/account-risk patterns.",
    verdict:
      "Binarium should remain a research-only profile until official product terms, entity details, deposits, withdrawals, and affiliate claims are verified from reliable sources.",
    ...
    regulation: "No valid mainstream regulation verified; CySEC/FCA warning records reported by broker databases",
    ...
    pros: [
      ...
      "Third-party databases provide entity, warning and minimum-deposit leads for further verification",
    ],
    cons: [
      ...
      "CySEC/FCA warning records are reported by databases",
    ...
    safetyChecks: [
      ...
      { label: "Regulation", status: "fail", detail: "WikiFX/BrokersView report unregulated status and warning records." },
    ...
    timeline: [
      ...
      { year: "2022", title: "CySEC warning reported", detail: "BrokersView reports CySEC warning records around Binarium." },
      { year: "2025-2026", title: "Additional warning signals", detail: "WikiFX/BrokersView records include FCA/CySEC style warning and low-score signals." },
    ],
    faqs: [
      {
